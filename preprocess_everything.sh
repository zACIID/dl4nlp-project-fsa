...
#&& poetry run python src/fine_tuned_finbert/datasets/semeval_2017/preprocessing.py --get-train-dataset \ # TODO can preprocess train, test all in one
...
#&& poetry run python src/hand_eng_mlp_TODO/datasets/semeval_2017/preprocessing.py --get-train-dataset \  # TODO can preprocessi train, test all in one
