...
_FT_DM = ft_dm.Semeval2017Test()
_FT_DM.setup()
_FT_COLLATE_FN = _FT_DM.test_dataloader().collate_fn
_HEMLP_DM = mlp_dm.Semeval2017Test()
_HEMLP_DM.setup()
_HEMLP_COLLATE_FN = _HEMLP_DM.test_dataloader().collate_fn
