...
# TODO ============ IMPORTANT ====================
# TODO THIS SCRIPT IS INTENDED TO MAKE SINGLE TRAINING RUN DEBUG EASIER
#   the below env vars make it so that MLP model and SEMEVAL_TRAIN_VAL datasets are used,
#   but can and should be changed for testing purposes
#   This script will then be removed once MLP is stable
...
def train(
    ...
    with mlflow.start_run(
            ...
            run_name=f"TEST_DEBUG_RUN-{env.get_model_choice()}-{env.get_dataset_choice()}"
    ) as run:
